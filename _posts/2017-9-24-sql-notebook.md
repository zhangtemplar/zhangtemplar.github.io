---
layout: post
title: Franchise, a SQL notebook
---

[Franchise](https://github.com/HVF/franchise) is a lightweight but powerful SQL tool with a notebook interface. You can use it online at [franchise.cloud](franchise.cloud). You can query SQL as easy as Jupyter notebook, which is very popular for Python.
