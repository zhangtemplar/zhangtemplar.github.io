...
A [repository in Github](https://github.com/likedan/Awesome-CoreML-Models) has put up the largest collection of machine learning models that work with Apples Core ML standard, to help iOS developers experiment with machine learning techniques.
